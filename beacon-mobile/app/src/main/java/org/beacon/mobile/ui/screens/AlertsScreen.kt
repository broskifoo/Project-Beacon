                    ...
                    Card(
                        ...
                        androidx.compose.foundation.layout.Box(
                            ...
                            Column(
                                ...
                                Icon(
                                    androidx.compose.material.icons.Icons.Default.NotificationImportant,
                                    contentDescription = null,
                                    modifier = Modifier.size(48.dp),
                                    tint = androidx.compose.material3.MaterialTheme.colorScheme.onSurfaceVariant.copy(alpha = 0.3f)
                                )
                                Text("No active alerts", fontSize = 18.sp, fontWeight = FontWeight.Medium)
                                Text("Emergency broadcasts will appear here", fontSize = 14.sp, color = androidx.compose.material3.MaterialTheme.colorScheme.onSurfaceVariant.copy(alpha = 0.6f))
                            }
                        }
                    }
                }
